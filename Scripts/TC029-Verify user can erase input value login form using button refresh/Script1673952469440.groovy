...
WebUI.setText(findTestObject('Username text field'), '123asd')

WebUI.verifyElementPresent(findTestObject('Password text field'), 0)

WebUI.setText(findTestObject('Password text field'), '123asd')
...
WebUI.getText(findTestObject('Username text field'), FailureHandling.STOP_ON_FAILURE)

WebUI.getText(findTestObject('Password text field'))

WebUI.verifyNotMatch('', '123asd', false)
