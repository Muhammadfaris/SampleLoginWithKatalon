...
WebUI.click(findTestObject('Button nav home page'))

WebUI.waitForElementPresent(findTestObject('Navigation menu home page'), 0)

WebUI.verifyElementPresent(findTestObject('Log out navigation text'), 0)

WebUI.click(findTestObject('Log out navigation text'))

WebUI.waitForElementPresent(findTestObject('Login page'), 0)

WebUI.forward()

WebUI.verifyElementNotPresent(findTestObject('Home page'), 0)
